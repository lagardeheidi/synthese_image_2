...
int main()
{
    ...
    Vertex2DColor vertices[] = {
        ...
        Vertex2DColor{{-0.5f, -0.5f}, {1.f, 0.f, 0.f}}, // Quatrième sommet
        Vertex2DColor{{-0.5f, 0.5f}, {0.f, 1.f, 0.f}},  // Cinquième sommet
        Vertex2DColor{{0.5f, 0.5f}, {0.f, 0.f, 1.f}}    // Sixième sommet
    };
